...
<div class="grid grid-cols-2 gap-4">
  <div>
    ...
    <div
      class="grid grid-cols-5 pt-8 items-center [&_svg]:h-10 [&_svg]:w-10 [&_svg]:fill-gray-400 [&_svg]:hover:fill-cyan-200"
    >
      <div>
        <a href={stateCtx.profile.whatsapp} aria-label={stateCtx.profile.whatsapp}>
      ...
      <div>
        <a href={stateCtx.profile.telegram} aria-label={stateCtx.profile.telegram}>
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640"
            ><path
      ...
      <div>
        <a href={stateCtx.profile.linkedin} aria-label={stateCtx.profile.linkedin}>
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640"
            ><path
      ...
      <div>
        <a href={stateCtx.profile.github} aria-label={stateCtx.profile.github}>
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640"
            ><path
      ...
      <div>
        <a href={stateCtx.profile.cv} aria-label={stateCtx.profile.cv}>
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640"
            ><path
