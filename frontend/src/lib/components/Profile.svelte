      ...
      {#if stateCtx.certificates.length > 0}
        {#each stateCtx.certificates as skill}
          <div class="swiper-slide h-auto! flex">
            <div
              class="group h-full flex flex-col gap-4 px-0 lg:px-10 py-4 rounded-2xl transition-all duration-300 hover:bg-white/5 hover:backdrop-blur-md
            ...
            >
              ...
              >
                {#if skill.skill_url}
                  ...
                  >
                    <div class="text-md pr-2">{skill.name}</div>
                    <svg class="h-6 w-6 shrink-0 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640"
                      ><path
                ...
                {:else}
                  <div class="text-md justify-center">{skill.name}</div>
                {/if}
              </div>
            </div>
          </div>
