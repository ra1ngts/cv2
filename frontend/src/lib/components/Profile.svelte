      ...
      <div class="w-fit flex flex-col justify-center gap-4">
        ...
        >
          ...
          {#if stateCtx.profile.email}
            <div>
              <a href="mailto:{stateCtx.profile.email}" aria-label="Mail to: {stateCtx.profile.email}">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640"
                  ><path
            ...
            >
              ...
              >
                {#if skill.skill_url}
                  ...
                  >
                    {skill.name}
                    <svg class="w-6 h-6 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640"
                      ><path
